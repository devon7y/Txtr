...
const DIFFICULTIES = {
  ...
  normal: { id: "normal", name: "Normal",  spawnBase: 1.10, ramp: 0.26, doubleChance: 0.40, startSpeed: 30, send: { base: 8.0, per: 0.44 }, label: "Rush hour, type before time runs out" },
